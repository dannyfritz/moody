...
var Moody = (function () {
    ...
    */
    Moody.prototype.current = function () {
    ...
    */
    Moody.prototype.push = function (state) {
        var args = [];
    ...
    */
    Moody.prototype.pop = function () {
        var poppedState = this.states.pop();
        var newState = this.current();
    ...
    /**
      ...
      @return enterReturn {Mixed}
    */
    Moody.prototype.swap = function (toState) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
    ...
    */
    Moody.prototype.execute = function (functionName) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
